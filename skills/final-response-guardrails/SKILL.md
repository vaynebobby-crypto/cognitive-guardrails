...
description: "Use after completing work and before the final response to check delivery claims, verification evidence, unfinished items, blockers, uncertainty, and overpromising."
metadata:
  openclaw:
    category: reasoning
  security:
...
Use this skill after work is complete and before sending the final response. It is a delivery review layer for making sure the response matches what was actually done, verified, and left unfinished.
